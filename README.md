...
|---------------------------|--------------|-----------   |
| UCSBDiningCommonsMenuItem |    Ruben     |RubenAlvarezGJ|
| UCSBOrganization          |    Fred      |  JiaaoZheng  |
| RecommendationRequest     |    Andrew    |  andrewkim102|
| MenuItemReview            |    Jason     |  jasozh5     |
| HelpRequest               |    Joel      |  jsanchez021 |
| Articles                  |    Moiez     |  moiez12     |
